...
var Material;
(function (Material) {
    Material[Material["Destructible"] = 0] = "Destructible";
    Material[Material["Indestructible"] = 1] = "Indestructible";
...
var layerTile = new LayerTile_1.LayerTile();
layerTile.load(stageGame);
var layerDynamicItem = new LayerDynamicItem_1.LayerDynamicItem();
...
let left = new KeyboardState(37), up = new KeyboardState(38), right = new KeyboardState(39), down = new KeyboardState(40), showBomb = new KeyboardState(32);
right.press = () => {
...
const Background_1 = __webpack_require__(4);
class LayerTile {
    constructor() {
        this.arrayBlock = [];
    }
    load(stageLayer) {
        let background = new Background_1.Background(0, 0);
        stageLayer.addChild(background.sprite);
        for (let x = 0; x < 10; x++) {
            this.arrayBlock[x] = [];
            for (let y = 0; y < 10; y++) {
                let block = new Block_1.Block(x * 120, y * 120);
...
class Background {
    constructor(x, y) {
        ...
        this._sprite.position.x = x;
        this._sprite.position.y = y;
        this._material = Material_1.Material.Indestructible;
    }
    //#region GETTER-SETTER
    get sprite() {
        return this._sprite;
...
/* harmony export (immutable) */ __webpack_exports__["Bump"] = Bump;
